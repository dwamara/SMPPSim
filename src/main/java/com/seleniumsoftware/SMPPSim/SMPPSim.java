 ...
 *
 * @author martin.woolley@seleniumsoftware.com http://www.seleniumsoftware.com http://www.seleniumsoftware.com $Header: /var/cvsroot/SMPPSim2/distribution/2.6.9/SMPPSim/src/java/com/seleniumsoftware/SMPPSim/SMPPSim.java,v
 * 1.1 2012/07/24 14:48:59 martin Exp $ ***************************************************************************
 * <p>
 * This server simulates the basic behaviour of a Logical Aldiscom SMSC with respect to SMPP based interaction between an application and the SMSC. Its intended purpose is to allow
 * basic testing of an SMPP application. It is not an SMSC. It is not a full and comprehensive implementation. With this utility, sufficient testing, to be confident that the main
 * message types are implemented correctly can take place without the need for access to a real SMSC. Once testing with this simulator is completed, final testing should take place
 * using such an SMSC.
 * <p>
 * <p>
 * ================================================================================================================
